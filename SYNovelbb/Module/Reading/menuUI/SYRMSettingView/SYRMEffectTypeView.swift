...
class SYRMEffectTypeView: SYRMBaseView {
    ...
    override func setupUI() {
        ...
        for i in 0..<count {
            ...
            if i == SYReadConfigure.shared().effectIndex.intValue { selectItem(item) }
        }
    }
    ...
    @objc private func clickItem(_ item:UIButton) {
        ...
        SYReadConfigure.shared().effectIndex = NSNumber(value: item.tag)
