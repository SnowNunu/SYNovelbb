...
class SYRMFontSizeView: SYRMBaseView {
    ...
    override func setupUI() {
        ...
        fontSize = UILabel()
        fontSize.text = "\(SYReadConfigure.shared().fontSize.stringValue)"
        ...
        displayProgress.isSelected = SYReadConfigure.shared().progressIndex.boolValue
    ...
    @objc private func clickDisplayProgress(button:UIButton) {
        ...
        SYReadConfigure.shared().progressIndex = NSNumber(value: button.isSelected)
    ...
    @objc private func clickLeftButton() {
        ...
        let size = NSNumber(value: SYReadConfigure.shared().fontSize.intValue - DZM_READ_FONT_SIZE_SPACE)
