...
class SYRMFontTypeView: SYRMBaseView {
    ...
    override func setupUI() {
        ...
        for i in 0..<count {
            ...
            if i == SYReadConfigure.shared().fontIndex.intValue { selectItem(item) }
        }
    }
    ...
    @objc private func clickItem(_ item:UIButton) {
        ...
        SYReadConfigure.shared().fontIndex = NSNumber(value: item.tag)
