...
class SYRMSpacingView: SYRMBaseView {
    ...
    override func setupUI() {
        ...
        for i in 0..<count {
            ...
            if i == SYReadConfigure.shared().spacingIndex.intValue { selectItem(item) }
        }
    }
    ...
    @objc private func clickItem(_ item:DZMRMSpacingItem) {
        ...
        SYReadConfigure.shared().spacingIndex = NSNumber(value: item.tag)
